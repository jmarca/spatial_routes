...
exports.carb_areas = function carb_areas(options,config_file,app){
    var opts
    var optch,county_handler
    var optbh,basin_handler
    var optdh,district_handler
    var optgh,grid4k_handler
    ...
    optch = Object.assign({},opts.county_handler,options)
    county_handler = shape_service(optch)
    // set the routes
    ...
    optbh = Object.assign({},opts.basin_handler,options)
    basin_handler = shape_service(optbh)
    ...
    optdh = Object.assign({},opts.district_handler,options)
    district_handler = shape_service(optdh)
    ...
    optgh = Object.assign({},opts.grid4k_handler,options)
    grid4k_handler = shape_service(optgh)
