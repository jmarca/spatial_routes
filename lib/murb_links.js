...
exports.murb_links = function murb_links(options,app){
    ...
    if(options.host !== undefined) phost = default_options.host
    if(options.port !== undefined) pport = default_options.port
    if(options.username !== undefined) puser = default_options.username
    if(options.password !== undefined) ppass = default_options.password
