...
exports.detectors = function detectors(options,config_file,app){
    var opts
    var vds_options,wim_options
    var vss,wss,chained_service
    ...
    vds_options=Object.assign({},opts.vds,options)
    wim_options=Object.assign({},opts.wim,options)

    vss = shape_service(vds_options)
    wss = shape_service(wim_options)
    ...
    chained_service = function(req,res,next){
        async.parallel([
            function(cb){
                vss(req,res,next,function(data){
                    cb(null,data)
                })
            }
            ,function(cb){
                wss(req,res,next,function(data){
                    cb(null,data)
                })
            }]
